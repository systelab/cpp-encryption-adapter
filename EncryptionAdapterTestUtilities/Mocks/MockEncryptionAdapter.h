...
namespace systelab { namespace encryption { namespace test_utility {
	...
	public:
		...
		MOCK_CONST_METHOD2(encryptString, std::string(const std::string& key, const std::string& input));
		MOCK_CONST_METHOD2(decryptString, std::string(const std::string& key, const std::string& input));
	};
